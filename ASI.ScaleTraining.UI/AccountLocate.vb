...
#Region " Events - Form "
  ...
  Private Sub Accounts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    testOutput.Text = Environment.GetCommandLineArgs(1)
    ...
    Else
      ...
      MessageBox.Show("Invalid arguments.  The command line should be in the form ""ASI.ScaleTesting.UI.exe <UserCode>"".",
                      "Error",
                      MessageBoxButtons.OK,
                      MessageBoxIcon.Error)
      Me.Close()
...
#Region " Events - Listview "
  ...
  'Testing output of command line args
